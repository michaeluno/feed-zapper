 ...
 * @since    0.0.1
 */
class FeedZapper_Option_Base extends FeedZapper_PluginUtility {
    ...
    public function getDefaults( array $aOptions=array() ) {
        return apply_filters(
            FeedZapper_Registry::HOOK_SLUG . '_filter_default_options',
            $aOptions
        );
    }    
    ...
    public function hasUpgraded() {
        ...
        $_sOptionVersion        = $this->___getVersionByDepth( $_sOptionVersion );
        $_sCurrentVersion       = $this->___getVersionByDepth( FeedZapper_Registry::VERSION );
         ...
         * @since    0.0.1
         */
        private function ___getVersionByDepth( $sVersion, $iDepth=2 ) {
            if ( ! $iDepth ) {
                return $sVersion;
            }
