 ...
 * @package     FeedZapper_AdminPageFramework
 */

if ( ! class_exists( 'FeedZapper_Select2CustomFieldType' ) ) :
/**
 ...
 */
class FeedZapper_Select2CustomFieldType extends FeedZapper_AdminPageFramework_FieldType_select {
...
"jQuery( document ).ready( function(){
    ...
    var _initializeSelect2 = function( oNode ) {
        ...
        if ( _aOptions[ 'width' ] && 'auto' !== _aOptions[ 'width' ] ) {
            var _oFieldContainer = _oSelect2Target.closest( '.feed-zapper-field-select2' );
            _oFieldContainer.css( 'width', _aOptions[ 'width' ] );
            _oFieldContainer.children( '.feed-zapper-select-label' )
                .css( 'width', '100%' );
            _oFieldContainer.children( '.feed-zapper-select-label' )
                .children( 'label' )
                .children( '.feed-zapper-input-container' )
                .css( 'width', '100%' );
            _aOptions[ 'width' ] = '100%';
        }
        ...
        if ( _aOptions[ 'search_callback' ] ) {
             ...
             * Set inital values.
             */
            var _oInputForEncoded = _oSelect2Target.closest( '.feed-zapper-field' )
            ...
            _oSelect2Target.on( 'change', function( event ){
                ...
                jQuery( this ).closest( '.feed-zapper-field' )
                    .children( 'input[data-encoded]' ).first()
    ...
    jQuery().registerFeedZapper_AdminPageFrameworkCallbacks( {
        /**
    ...
    protected function getStyles() {
        return "
.feed-zapper-field-select2 .select2-container {     
    min-width: 200px;
    width: auto;
}

.feed-zapper-field-select2 {
    max-width: 96%;
}

/* Make a room for repeatable buttons */
.repeatable .feed-zapper-field-select2 > .feed-zapper-select-label > label > .feed-zapper-input-container {
    max-width: 84%;
}
