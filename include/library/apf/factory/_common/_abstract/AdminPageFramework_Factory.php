...
abstract class FeedZapper_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'FeedZapper_AdminPageFramework_Form_', 'oPageLoadInfo' => 'FeedZapper_AdminPageFramework_PageLoadInfo_', 'oResource' => 'FeedZapper_AdminPageFramework_Resource_', 'oHelpPane' => 'FeedZapper_AdminPageFramework_HelpPane_', 'oLink' => 'FeedZapper_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'FeedZapper_AdminPageFramework_Debug', 'oUtil' => 'FeedZapper_AdminPageFramework_FrameworkUtility', 'oMsg' => 'FeedZapper_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(FeedZapper_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return FeedZapper_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
...
abstract class FeedZapper_AdminPageFramework_Factory_Model extends FeedZapper_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class FeedZapper_AdminPageFramework_Factory_View extends FeedZapper_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new FeedZapper_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class FeedZapper_AdminPageFramework_Factory_Controller extends FeedZapper_AdminPageFramework_Factory_View {
...
abstract class FeedZapper_AdminPageFramework_Factory extends FeedZapper_AdminPageFramework_Factory_Controller {
}
