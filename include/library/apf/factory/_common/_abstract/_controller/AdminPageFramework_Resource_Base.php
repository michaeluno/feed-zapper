...
abstract class FeedZapper_AdminPageFramework_Resource_Base extends FeedZapper_AdminPageFramework_FrameworkUtility {
    ...
    protected $_sClassSelector_Style = 'feed-zapper-style';
    protected $_sClassSelector_Script = 'feed-zapper-script';
    ...
    private function _getStyleTag($oCaller, $sIDPrefix) {
        $_sStyle = $this->addAndApplyFilters($oCaller, array("style_common_admin_page_framework", "style_common_{$this->oProp->sClassName}",), FeedZapper_AdminPageFramework_CSS::getDefaultCSS());
    ...
    private function _getIEStyleTag($oCaller, $sIDPrefix) {
        $_sStyleIE = $this->addAndApplyFilters($oCaller, array("style_ie_common_admin_page_framework", "style_ie_common_{$this->oProp->sClassName}",), FeedZapper_AdminPageFramework_CSS::getDefaultCSSIE());
    ...
    protected function _printCommonScripts($sIDPrefix, $sClassName) {
        ...
        $_sScript = $this->addAndApplyFilters($this->oProp->oCaller, array("script_common_admin_page_framework", "script_common_{$this->oProp->sClassName}",), FeedZapper_AdminPageFramework_Property_Base::$_sDefaultScript);
    ...
    public function _replyToAddStyle() {
        ...
        $this->_printCommonStyles('feed-zapper-style-common', get_class());
    ...
    public function _replyToAddScript() {
        ...
        $this->_printCommonScripts('feed-zapper-script-common', get_class());
