...
abstract class FeedZapper_AdminPageFramework_Property_Base extends FeedZapper_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'feed-zapper' : $sTextDomain;
    ...
    private function ___getURLQuery() {
        ...
        parse_str(parse_url($_SERVER['HTTP_REFERER'], PHP_URL_QUERY), $_aQuery);
        return $_GET + $_aQuery;
    }
    private function ___setGlobals() {
        if (!isset($GLOBALS['aFeedZapper_AdminPageFramework'])) {
            $GLOBALS['aFeedZapper_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => FeedZapper_AdminPageFramework_Registry::NAME, 'sURI' => FeedZapper_AdminPageFramework_Registry::URI, 'sScriptName' => FeedZapper_AdminPageFramework_Registry::NAME, 'sLibraryName' => FeedZapper_AdminPageFramework_Registry::NAME, 'sLibraryURI' => FeedZapper_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => FeedZapper_AdminPageFramework_Registry::getVersion(), 'sDescription' => FeedZapper_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => FeedZapper_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => FeedZapper_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => FeedZapper_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => FeedZapper_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new FeedZapper_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
