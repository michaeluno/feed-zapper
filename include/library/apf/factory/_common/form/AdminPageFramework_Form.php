...
abstract class FeedZapper_AdminPageFramework_Form_Utility extends FeedZapper_AdminPageFramework_FrameworkUtility {
    ...
    static public function getFieldsetReformattedBySubFieldIndex($aFieldset, $iSubFieldIndex, $bHasSubFields, $aParentFieldset) {
        ...
        $_oFieldsetFormatter = new FeedZapper_AdminPageFramework_Form_Model___Format_Fieldset($aFieldset, $aFieldset['_structure_type'], $aFieldset['capability'], ( integer )$iSubFieldIndex + 1, $aFieldset['_subsection_index'], $aFieldset['_is_section_repeatable'], $aFieldset['_caller_object']);
        $aFieldset = $_oFieldsetFormatter->get();
        $_oFieldsetOutputFormatter = new FeedZapper_AdminPageFramework_Form_Model___Format_FieldsetOutput($aFieldset, $aFieldset['_section_index'], $_oCallerForm->aFieldTypeDefinitions);
...
abstract class FeedZapper_AdminPageFramework_Form_Base extends FeedZapper_AdminPageFramework_Form_Utility {
...
class FeedZapper_AdminPageFramework_Form_Model extends FeedZapper_AdminPageFramework_Form_Base {
    ...
    public function getSortedInputs(array $aFormInputs) {
        ...
        $_oInputSorter = new FeedZapper_AdminPageFramework_Form_Model___Modifier_SortInput($aFormInputs, $_aDynamicFieldAddressKeys);
    ...
    public function dropRepeatableElements(array $aSubject) {
        $_oFilterRepeatableElements = new FeedZapper_AdminPageFramework_Form_Model___Modifier_FilterRepeatableElements($aSubject, $this->getElementAsArray($_POST, '__repeatable_elements_' . $this->aArguments['structure_type']));
    ...
    public function _replyToRegisterFormItems() {
        ...
        $_oFieldResources = new FeedZapper_AdminPageFramework_Form_Model___SetFieldResources($this->aArguments, $this->aFieldsets, self::$_aResources, $this->aFieldTypeDefinitions, $this->aCallbacks);
    ...
    private function _setSiteWideFieldTypeDefinitions() {
        ...
        $_oBuiltInFieldTypeDefinitions = new FeedZapper_AdminPageFramework_Form_Model___BuiltInFieldTypeDefinitions('admin_page_framework', $this->oMsg);
    ...
    public function getDefaultFormValues() {
        $_oDefaultValues = new FeedZapper_AdminPageFramework_Form_Model___DefaultValues($this->aFieldsets);
        return $_oDefaultValues->get();
    }
    protected function _formatElementDefinitions(array $aSavedData) {
        $_oSectionsetsFormatter = new FeedZapper_AdminPageFramework_Form_Model___FormatSectionsets($this->aSectionsets, $this->aArguments['structure_type'], $this->sCapability, $this->aCallbacks, $this);
        $this->aSectionsets = $_oSectionsetsFormatter->get();
        $_oFieldsetsFormatter = new FeedZapper_AdminPageFramework_Form_Model___FormatFieldsets($this->aFieldsets, $this->aSectionsets, $this->aArguments['structure_type'], $this->aSavedData, $this->sCapability, $this->aCallbacks, $this);
...
class FeedZapper_AdminPageFramework_Form_View extends FeedZapper_AdminPageFramework_Form_Model {
    public function __construct() {
        parent::__construct();
        new FeedZapper_AdminPageFramework_Form_View__Resource($this);
    }
    public function get() {
        ...
        new FeedZapper_AdminPageFramework_Form_View___Script_Form;
        $_oFormTables = new FeedZapper_AdminPageFramework_Form_View___Sectionsets(array('capability' => $this->sCapability,) + $this->aArguments, array('field_type_definitions' => $this->aFieldTypeDefinitions, 'sectionsets' => $this->aSectionsets, 'fieldsets' => $this->aFieldsets,), $this->aSavedData, $this->callBack($this->aCallbacks['field_errors'], array($this->getFieldErrors())), $this->aCallbacks, $this->oMsg);
    ...
    private function _getNoScriptMessage() {
        ...
        return "<noscript>" . "<div class='error'>" . "<p class='feed-zapper-form-warning'>" . $this->oMsg->get('please_enable_javascript') . "</p>" . "</div>" . "</noscript>";
    }
    public function printSubmitNotices() {
        $this->oSubmitNotice->render();
    }
}
class FeedZapper_AdminPageFramework_Form_Controller extends FeedZapper_AdminPageFramework_Form_View {
...
class FeedZapper_AdminPageFramework_Form extends FeedZapper_AdminPageFramework_Form_Controller {
    ...
    public $oFieldError;
    public $oLastInputs;
    public $aSubClasses = array('submit_notice' => 'FeedZapper_AdminPageFramework_Form___SubmitNotice', 'field_error' => 'FeedZapper_AdminPageFramework_Form___FieldError', 'last_input' => 'FeedZapper_AdminPageFramework_Form_Model___LastInput', 'message' => 'FeedZapper_AdminPageFramework_Message',);
    public function __construct() {
