...
class FeedZapper_AdminPageFramework_Form_Model___BuiltInFieldTypeDefinitions {
    ...
    public function get() {
        ...
        foreach (self::$_aDefaultFieldTypeSlugs as $_sFieldTypeSlug) {
            $_sFieldTypeClassName = "FeedZapper_AdminPageFramework_FieldType_{$_sFieldTypeSlug}";
