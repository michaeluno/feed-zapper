...
class FeedZapper_AdminPageFramework_Form_Model___SetFieldResources extends FeedZapper_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new FeedZapper_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('FeedZapper_AdminPageFramework_Form_View___CSS_Form', 'FeedZapper_AdminPageFramework_Form_View___CSS_Field', 'FeedZapper_AdminPageFramework_Form_View___CSS_Section', 'FeedZapper_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'FeedZapper_AdminPageFramework_Form_View___CSS_FieldError', 'FeedZapper_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('FeedZapper_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new FeedZapper_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new FeedZapper_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
