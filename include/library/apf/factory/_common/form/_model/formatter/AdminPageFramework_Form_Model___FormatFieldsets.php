...
class FeedZapper_AdminPageFramework_Form_Model___FormatFieldsets extends FeedZapper_AdminPageFramework_Form_Base {
    ...
    private function _getDynamicElementsAddedToFieldsets() {
        $_oDynamicElements = new FeedZapper_AdminPageFramework_Form_Model___FormatDynamicElements($this->aSectionsets, $this->aFieldsets, $this->aSavedData);
    ...
    private function _getFieldsetFormatted($aFieldset, $aSectionsets, $sCapability, $iCountOfElements, $iSubSectionIndex, $bIsSectionRepeatable, $oCallerObject) {
        ...
        $_oFieldsetFormatter = new FeedZapper_AdminPageFramework_Form_Model___Format_Fieldset($aFieldset, $this->sStructureType, $sCapability, $iCountOfElements, $iSubSectionIndex, $bIsSectionRepeatable, $oCallerObject);
