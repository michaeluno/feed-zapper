...
class FeedZapper_AdminPageFramework_Form_Model___FormatSectionset extends FeedZapper_AdminPageFramework_Form_Utility {
    ...
    public function get() {
        ...
        $_oCollapsibleArgumentFormatter = new FeedZapper_AdminPageFramework_Form_Model___Format_CollapsibleSection($_aSectionset['collapsible'], $_aSectionset['title']);
