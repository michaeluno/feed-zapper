...
class FeedZapper_AdminPageFramework_Form_Model___FormatSectionsets extends FeedZapper_AdminPageFramework_Form_Base {
    ...
    private function _getSectionsetsFormatted($_aNewSectionsets, $aSectionsetsToParse, $aSectionPath, $sCapability) {
        foreach ($aSectionsetsToParse as $_sSectionPath => $_aSectionset) {
            ...
            $_aSectionsetFormatter = new FeedZapper_AdminPageFramework_Form_Model___FormatSectionset($_aSectionset, $_sSectionPath, $this->sStructureType, $sCapability, count($_aNewSectionsets), $this->oCallerForm, $this->callBack($this->aCallbacks['show_debug_info'], true));
