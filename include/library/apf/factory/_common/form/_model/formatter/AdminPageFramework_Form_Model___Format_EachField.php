...
abstract class FeedZapper_AdminPageFramework_Form_Model___Format_FormField_Base extends FeedZapper_AdminPageFramework_Form_Utility {
}
class FeedZapper_AdminPageFramework_Form_Model___Format_EachField extends FeedZapper_AdminPageFramework_Form_Model___Format_FormField_Base {
    ...
    public function get() {
        ...
        $_oInputTagIDGenerator = new FeedZapper_AdminPageFramework_Form_View___Generate_FieldInputID($_aField, $this->isIndex, $this->aCallbacks['hfID']);
        $_aField['input_id'] = $_oInputTagIDGenerator->get();
        $_oFieldInputNameGenerator = new FeedZapper_AdminPageFramework_Form_View___Generate_FieldInputName($_aField, $this->getAOrB($_aField['_is_multiple_fields'], $this->isIndex, ''), $this->aCallbacks['hfInputName']);
        $_aField['_input_name'] = $_oFieldInputNameGenerator->get();
        $_oFieldFlatInputName = new FeedZapper_AdminPageFramework_Form_View___Generate_FlatFieldInputName($_aField, $this->getAOrB($_aField['_is_multiple_fields'], $this->isIndex, ''), $this->aCallbacks['hfInputNameFlat']);
        ...
        $_aField['_field_object'] = new FeedZapper_AdminPageFramework_ArrayHandler($_aField);
        return $_aField;
    }
}
