...
class FeedZapper_AdminPageFramework_Form_Model___Format_Fieldset extends FeedZapper_AdminPageFramework_Form_Model___Format_FormField_Base {
    ...
    private function _getChildFieldsetsFormatted(array $aNestedFieldsets, array $aParentFieldset) {
        ...
        foreach ($aNestedFieldsets as $_isIndex => & $_aNestedFieldset) {
            ...
            $_oFieldsetFormatter = new FeedZapper_AdminPageFramework_Form_Model___Format_Fieldset($_aNestedFieldset + $_aInheritingFieldsetValues, $this->sStructureType, $this->sCapability, $this->iCountOfElements, $this->iSubSectionIndex, $this->bIsSectionRepeatable, $this->oCallerObject);
            $_aNestedFieldset = $_oFieldsetFormatter->get();
        }
        return $aNestedFieldsets;
    }
}
class FeedZapper_AdminPageFramework_Form_Model___Format_FieldsetOutput extends FeedZapper_AdminPageFramework_Form_Model___Format_Fieldset {
    ...
    public function get() {
        ...
        $_oFieldTagIDGenerator = new FeedZapper_AdminPageFramework_Form_View___Generate_FieldTagID($_aFieldset, $_aFieldset['_caller_object']->aCallbacks['hfTagID']);
        $_aFieldset['tag_id'] = $_oFieldTagIDGenerator->get();
        $_aFieldset['_tag_id_model'] = $_oFieldTagIDGenerator->getModel();
        $_oFieldNameGenerator = new FeedZapper_AdminPageFramework_Form_View___Generate_FieldName($_aFieldset, $_aFieldset['_caller_object']->aCallbacks['hfName']);
        $_aFieldset['_field_name'] = $_oFieldNameGenerator->get();
        $_aFieldset['_field_name_model'] = $_oFieldNameGenerator->getModel();
        $_oFieldFlatNameGenerator = new FeedZapper_AdminPageFramework_Form_View___Generate_FlatFieldName($_aFieldset, $_aFieldset['_caller_object']->aCallbacks['hfNameFlat']);
        ...
        $_oFieldAddressGenerator = new FeedZapper_AdminPageFramework_Form_View___Generate_FieldAddress($_aFieldset);
        ...
        if ($this->hasFieldDefinitionsInContent($_aFieldset)) {
            foreach ($_aFieldset['content'] as & $_aNestedFieldset) {
                ...
                $_oFieldsetOutputFormatter = new FeedZapper_AdminPageFramework_Form_Model___Format_FieldsetOutput($_aNestedFieldset, $this->iSectionIndex, $this->aFieldTypeDefinitions);
