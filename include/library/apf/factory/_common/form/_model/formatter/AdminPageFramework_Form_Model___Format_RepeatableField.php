...
class FeedZapper_AdminPageFramework_Form_Model___Format_RepeatableSection extends FeedZapper_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : FeedZapper_AdminPageFramework_Message::getInstance();
    }
    public function get() {
...
class FeedZapper_AdminPageFramework_Form_Model___Format_RepeatableField extends FeedZapper_AdminPageFramework_Form_Model___Format_RepeatableSection {
    protected function _getDefaultMessage() {
