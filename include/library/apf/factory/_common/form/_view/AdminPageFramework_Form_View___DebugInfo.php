...
class FeedZapper_AdminPageFramework_Form_View___DebugInfo extends FeedZapper_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='feed-zapper-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
