...
class FeedZapper_AdminPageFramework_Form_View___Description extends FeedZapper_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'feed-zapper-form-element-description';
