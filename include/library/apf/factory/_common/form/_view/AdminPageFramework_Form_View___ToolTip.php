...
class FeedZapper_AdminPageFramework_Form_View___ToolTip extends FeedZapper_AdminPageFramework_Form_View___Section_Base {
    ...
    public function get() {
        ...
        return "<a " . $this->_getElementAttributes('container', 'feed-zapper-form-tooltip') . ">" . $this->_getTipLinkIcon() . "<span " . $this->_getElementAttributes('content', 'feed-zapper-form-tooltip-content') . ">" . $this->_getTipTitle() . $this->_getDescriptions() . "</span>" . "</a>";
    }
    ...
    private function _getTipTitle() {
        if (isset($this->aArguments['title'])) {
            return "<span " . $this->_getElementAttributes('title', 'feed-zapper-form-tooltip-title') . ">" . $this->aArguments['title'] . "</span>";
        }
        return '';
    }
    private function _getDescriptions() {
        if (isset($this->aArguments['content'])) {
            return "<span " . $this->_getElementAttributes('description', 'feed-zapper-form-tooltip-description') . ">" . implode("</span><span " . $this->_getElementAttributes('description', 'feed-zapper-form-tooltip-description') . ">", $this->getAsArray($this->aArguments['content'])) . "</span>";
        }
        return '';
    }
