...
abstract class FeedZapper_AdminPageFramework_Form_View___Attribute_Base extends FeedZapper_AdminPageFramework_Form_Utility {
    public $sContext = '';
...
abstract class FeedZapper_AdminPageFramework_Form_View___Attribute_FieldContainer_Base extends FeedZapper_AdminPageFramework_Form_View___Attribute_Base {
    protected function _getFormattedAttributes() {
...
class FeedZapper_AdminPageFramework_Form_View___Attribute_Field extends FeedZapper_AdminPageFramework_Form_View___Attribute_FieldContainer_Base {
    public $sContext = 'field';
    protected function _getAttributes() {
        $_sFieldTypeSelector = $this->getAOrB($this->aArguments['type'], " feed-zapper-field-{$this->aArguments['type']}", '');
        ...
        return array('id' => $this->aArguments['_field_container_id'], 'data-type' => $this->aArguments['type'], 'class' => "feed-zapper-field{$_sFieldTypeSelector}{$_sNestedFieldSelector}{$_sMixedFieldSelector}{$_sChildFieldSelector}" . $this->getAOrB($this->aArguments['attributes']['disabled'], ' disabled', '') . $this->getAOrB($this->aArguments['_is_sub_field'], ' feed-zapper-subfield', ''));
    }
}
