...
class FeedZapper_AdminPageFramework_Form_View___Attribute_SectionTableContainer extends FeedZapper_AdminPageFramework_Form_View___Attribute_Base {
    protected function _getAttributes() {
        $_aSectionAttributes = $this->uniteArrays($this->dropElementsByType($this->aArguments['attributes']), array('id' => $this->aArguments['_tag_id'], 'class' => $this->getClassAttribute('feed-zapper-section', $this->getAOrB($this->aArguments['section_tab_slug'], 'feed-zapper-tab-content', null), $this->getAOrB($this->aArguments['_is_collapsible'], 'is_subsection_collapsible', null)),));
