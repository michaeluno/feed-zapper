...
class FeedZapper_AdminPageFramework_Form_View___Attribute_SectionsTablesContainer extends FeedZapper_AdminPageFramework_Form_View___Attribute_Base {
    ...
    protected function _getAttributes() {
        return array('id' => $this->sSectionsID, 'class' => $this->getClassAttribute('feed-zapper-sections', $this->getAOrB(!$this->sSectionTabSlug || '_default' === $this->sSectionTabSlug, null, 'feed-zapper-section-tabs-contents'), $this->getAOrB(empty($this->aCollapsible), null, 'feed-zapper-collapsible-sections-content' . ' ' . 'feed-zapper-collapsible-content' . ' ' . 'accordion-section-content'), $this->getAOrB(empty($this->aSectionset['sortable']), null, 'sortable-section')), 'data-seciton_id' => $this->aSectionset['section_id'], 'data-section_address' => $this->aSectionset['section_id'], 'data-section_address_model' => $this->aSectionset['section_id'] . '|' . '___i___',) + $this->_getDynamicElementArguments($this->aSectionset);
    }
    private function _getDynamicElementArguments($aSectionset) {
        ...
        $_oSectionNameGenerator = new FeedZapper_AdminPageFramework_Form_View___Generate_SectionName($aSectionset, $aSectionset['_caller_object']->aCallbacks['hfSectionName']);
