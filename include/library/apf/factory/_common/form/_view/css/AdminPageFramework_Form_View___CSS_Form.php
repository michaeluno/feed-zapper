...
class FeedZapper_AdminPageFramework_Form_View___CSS_Form extends FeedZapper_AdminPageFramework_Form_View___CSS_Base {
    protected function _get() {
        $_sSpinnerURL = esc_url(admin_url('/images/wpspin_light-2x.gif'));
        return ".feed-zapper-form-warning {font-size: 1em;}";
    }
}
