...
class FeedZapper_AdminPageFramework_Form_View___Generate_FieldTagID extends FeedZapper_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class FeedZapper_AdminPageFramework_Form_View___Generate_FieldInputID extends FeedZapper_AdminPageFramework_Form_View___Generate_FieldTagID {
    public $isIndex = '';
