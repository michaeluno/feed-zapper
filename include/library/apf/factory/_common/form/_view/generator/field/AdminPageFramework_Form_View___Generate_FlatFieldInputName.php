...
class FeedZapper_AdminPageFramework_Form_View___Generate_FieldInputName extends FeedZapper_AdminPageFramework_Form_View___Generate_FlatFieldName {
    public $sIndex = '';
...
class FeedZapper_AdminPageFramework_Form_View___Generate_FlatFieldInputName extends FeedZapper_AdminPageFramework_Form_View___Generate_FieldInputName {
    public function get() {
        $_sIndex = $this->getAOrB('0' !== $this->sIndex && empty($this->sIndex), '', "|{$this->sIndex}");
