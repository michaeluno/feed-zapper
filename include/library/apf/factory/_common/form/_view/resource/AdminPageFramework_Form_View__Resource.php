...
class FeedZapper_AdminPageFramework_Form_View__Resource extends FeedZapper_AdminPageFramework_FrameworkUtility {
    public $oForm;
    ...
    private function _setHooks() {
        ...
        new FeedZapper_AdminPageFramework_Form_View__Resource__Head($this->oForm, 'wp_head');
    }
    private function _setAdminHooks() {
        ...
        new FeedZapper_AdminPageFramework_Form_View__Resource__Head($this->oForm, 'admin_head');
    }
    ...
    public function _replyToAddStyle() {
        ...
        if ($_sCSSRules) {
            echo "<style type='text/css' id='internal-style-{$_sID}' class='feed-zapper-form-style'>" . $_sCSSRules . "</style>";
        }
        $_sIECSSRules = $this->_getFormattedInternalStyles($this->oForm->getResources('internal_styles_ie'));
        if ($_sIECSSRules) {
            echo "<!--[if IE]><style type='text/css' id='internal-style-ie-{$_sID}' class='feed-zapper-form-ie-style'>" . $_sIECSSRules . "</style><![endif]-->";
        }
    ...
    public function _replyToAddScript() {
        ...
        if ($_sScript) {
            $_sID = $this->sanitizeSlug(strtolower($this->oForm->aArguments['caller_id']));
            echo "<script type='text/javascript' id='internal-script-{$_sID}' class='feed-zapper-form-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
        }
