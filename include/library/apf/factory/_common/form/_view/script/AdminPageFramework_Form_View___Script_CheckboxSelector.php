...
class FeedZapper_AdminPageFramework_Form_View___Script_CheckboxSelector extends FeedZapper_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
     ...
     */        
    $.fn.selectAllFeedZapper_AdminPageFrameworkCheckboxes = function() {
        jQuery( this ).parent()
     ...
     */
    $.fn.deselectAllFeedZapper_AdminPageFrameworkCheckboxes = function() {
        jQuery( this ).parent()
            .find( 'input[type=checkbox]' )
            .attr( 'checked', false )
            .trigger( 'change' );   // 3.8.8+
