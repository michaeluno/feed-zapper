...
class FeedZapper_AdminPageFramework_Form_View___Script_Form extends FeedZapper_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removeFeedZapper_AdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.feed-zapper-form-loading' ).remove();
        jQuery( '.feed-zapper-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.feed-zapper-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removeFeedZapper_AdminPageFrameworkLoadingOutputs();
