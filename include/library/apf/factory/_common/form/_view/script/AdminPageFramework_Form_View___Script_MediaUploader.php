...
class FeedZapper_AdminPageFramework_Form_View___Script_MediaUploader extends FeedZapper_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
    ...
    getFeedZapper_AdminPageFrameworkCustomMediaUploaderSelectObject = function() {
