...
class FeedZapper_AdminPageFramework_Form_View___Script_SectionTab extends FeedZapper_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.feed-zapper-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='feed-zapper-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
