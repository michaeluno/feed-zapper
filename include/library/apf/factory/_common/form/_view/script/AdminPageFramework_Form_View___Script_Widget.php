...
class FeedZapper_AdminPageFramework_Form_View___Script_Widget extends FeedZapper_AdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.feed-zapper-sectionset' ).length <= 0 ) { 
                    return; 
                }   
