...
class FeedZapper_AdminPageFramework_Form_View___Section_Base extends FeedZapper_AdminPageFramework_Form_Base {
    ...
    public function getFieldsetOutput($aFieldset) {
        ...
        $_oFieldset = new FeedZapper_AdminPageFramework_Form_View___Fieldset($aFieldset, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->oMsg, $this->aCallbacks);
        $_sFieldOutput = $_oFieldset->get();
        return $_sFieldOutput;
    }
}
class FeedZapper_AdminPageFramework_Form_View___SectionTitle extends FeedZapper_AdminPageFramework_Form_View___Section_Base {
    ...
    private function _getToolTip($_aSectionset) {
        ...
        $_oToolTip = new FeedZapper_AdminPageFramework_Form_View___ToolTip($_aSectionset['tip'], $_sSectionTitleTagID);
    ...
    private function _getDebugInfo($aSectionset) {
        ...
        $_oToolTip = new FeedZapper_AdminPageFramework_Form_View___ToolTip(array('title' => $this->oMsg->get('section_arguments'), 'dash-icon' => 'dashicons-info', 'icon_alt_text' => '[' . $this->oMsg->get('debug') . ' ]', 'content' => FeedZapper_AdminPageFramework_Debug::getDetails($aSectionset) . '<span class="feed-zapper-info">' . $this->getFrameworkNameVersion() . '  (' . $this->oMsg->get('debug_info_will_be_disabled') . ')' . '</span>', 'attributes' => array('container' => array('class' => 'debug-info-field-arguments'),)), $aSectionset['_section_path'] . '_debug');
        return $_oToolTip->get();
    }
    private function _getCollapseButton($aCollapsible) {
        ...
        return $this->getAOrB('button' === $this->getElement($aCollapsible, 'type', 'box'), "<span class='feed-zapper-collapsible-button feed-zapper-collapsible-button-expand' title='{$_sExpand}'>&#9658;</span>" . "<span class='feed-zapper-collapsible-button feed-zapper-collapsible-button-collapse' title='{$_sCollapse}'>&#9660;</span>", '');
    }
    ...
    private function _getFieldsetsInSectionTitleArea(array $aFieldsets, $iSectionIndex, $aFieldTypeDefinitions) {
        ...
        foreach ($aFieldsets as $_aFieldset) {
            ...
            $_oFieldsetOutputFormatter = new FeedZapper_AdminPageFramework_Form_Model___Format_FieldsetOutput($_aFieldset, $iSectionIndex, $aFieldTypeDefinitions);
...
class FeedZapper_AdminPageFramework_Form_View___CollapsibleSectionTitle extends FeedZapper_AdminPageFramework_Form_View___SectionTitle {
    ...
    private function _getCollapsibleSectionTitleBlock(array $aCollapsible, $sContainer = 'sections', $iSectionIndex = null) {
        ...
        return $this->_getCollapsibleSectionsEnablerScript() . "<div " . $this->getAttributes(array('id' => $_sSectionTitleTagID, 'class' => $this->getClassAttribute('feed-zapper-section-title', $this->getAOrB('box' === $aCollapsible['type'], 'accordion-section-title', ''), 'feed-zapper-collapsible-title', $this->getAOrB('sections' === $aCollapsible['container'], 'feed-zapper-collapsible-sections-title', 'feed-zapper-collapsible-section-title'), $this->getAOrB($aCollapsible['is_collapsed'], 'collapsed', ''), 'feed-zapper-collapsible-type-' . $aCollapsible['type']),) + $this->getDataAttributeArray($aCollapsible)) . ">" . $_sSectionTitle . "</div>";
    }
    ...
    protected function _getCollapsibleSectionsEnablerScript() {
        ...
        self::$_bLoaded = true;
        new FeedZapper_AdminPageFramework_Form_View___Script_CollapsibleSection($this->oMsg);
    }
}
