...
abstract class FeedZapper_AdminPageFramework_FieldType_Base extends FeedZapper_AdminPageFramework_Form_Utility {
    ...
    public function __construct($asClassName = 'admin_page_framework', $asFieldTypeSlug = null, $oMsg = null, $bAutoRegister = true) {
        ...
        $this->oMsg = $oMsg ? $oMsg : FeedZapper_AdminPageFramework_Message::getInstance();
        if ($bAutoRegister) {
    ...
    protected function getFieldOutput(array $aFieldset) {
        ...
        $_oFieldset = new FeedZapper_AdminPageFramework_Form_View___Fieldset($aFieldset, $_oCallerForm->aSavedData, $_oCallerForm->getFieldErrors(), $_oCallerForm->aFieldTypeDefinitions, $_oCallerForm->oMsg, $_oCallerForm->aCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new FeedZapper_AdminPageFramework_Form_View___Script_MediaUploader($this->oMsg);
        } else {
...
abstract class FeedZapper_AdminPageFramework_FieldType extends FeedZapper_AdminPageFramework_FieldType_Base {
    public function _replyToFieldLoader() {
        $this->setUp();
    }
    public function _replyToGetScripts() {
...
class FeedZapper_AdminPageFramework_FieldType_color extends FeedZapper_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".repeatable .colorpicker {display: inline;}.feed-zapper-field-color .wp-picker-container {vertical-align: middle;}.feed-zapper-field-color .ui-widget-content {border: none;background: none;color: transparent;}.feed-zapper-field-color .ui-slider-vertical {width: inherit;height: auto;margin-top: -11px;}.feed-zapper-field-color .feed-zapper-repeatable-field-buttons {margin-top: 0;}.feed-zapper-field-color .wp-color-result {margin: 3px;}";
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        $_sDoubleQuote = '\"';
        return <<<JAVASCRIPTS
registerFeedZapper_AdminPageFrameworkColorPickerField = function( osTragetInput, aOptions ) {
    ...
    var _aDefaults = {
        ...
        change: function( event, ui ){
            jQuery( this ).trigger( 
                'feed-zapper_field_type_color_changed',
        ...
        clear: function( event, ui ) {
            jQuery( this ).trigger(
                'feed-zapper_field_type_color_cleared',
    ...
    jQuery().registerFeedZapper_AdminPageFrameworkCallbacks( {     
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( 'input.input_color' ).each( function( iIterationIndex ) {
                ...
                registerFeedZapper_AdminPageFrameworkColorPickerField( _oNewColorInput );                
...
JAVASCRIPTS;
    ...
    protected function getField($aField) {
        ...
        return $aField['before_label'] . "<div class='feed-zapper-input-label-container'>" . "<label for='{$aField['input_id']}'>" . $aField['before_input'] . ($aField['label'] && !$aField['repeatable'] ? "<span " . $this->getLabelContainerAttributes($aField, 'feed-zapper-input-label-string') . ">" . $aField['label'] . "</span>" : "") . "<input " . $this->getAttributes($aField['attributes']) . " />" . $aField['after_input'] . "<div class='repeatable-field-buttons'></div>" . "</label>" . "<div class='colorpicker' id='color_{$aField['input_id']}'></div>" . $this->_getColorPickerEnablerScript("{$aField['input_id']}") . "</div>" . $aField['after_label'];
    }
...
jQuery( document ).ready( function(){
    registerFeedZapper_AdminPageFrameworkColorPickerField( '{$sInputID}' );
});            
JAVASCRIPTS;
