...
class FeedZapper_AdminPageFramework_FieldType_submit extends FeedZapper_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".feed-zapper-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'feed-zapper-input-label-container' . ' feed-zapper-input-button-container' . ' feed-zapper-input-container',);
    }
...
class FeedZapper_AdminPageFramework_FieldType_export extends FeedZapper_AdminPageFramework_FieldType_submit {
