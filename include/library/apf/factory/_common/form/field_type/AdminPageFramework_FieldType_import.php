...
class FeedZapper_AdminPageFramework_FieldType_import extends FeedZapper_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".feed-zapper-field-import input {margin-right: 0.5em;}.feed-zapper-field-import label,.form-table td fieldset.feed-zapper-fieldset .feed-zapper-field-import label { display: inline; }";
    }
