...
class FeedZapper_AdminPageFramework_FieldType_image extends FeedZapper_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    jQuery().registerFeedZapper_AdminPageFrameworkCallbacks( { 
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            // Bind the event.
            var _oFieldContainer = oCloned.closest( '.feed-zapper-field' );
            ...
            setFeedZapper_AdminPageFrameworkImageUploader( 
 ...
 */
setFeedZapper_AdminPageFrameworkImageUploader = function( sInputID, fMultiple, fExternalSource ) {
    ...
    jQuery( '#select_image_' + sInputID ).click( function() {
        ...
        window.send_to_editor           = hfFeedZapper_AdminPageFrameworkSendToEditorImage;
...
var hfFeedZapper_AdminPageFrameworkSendToEditorImage = function( sRawHTML ) {
...
setFeedZapper_AdminPageFrameworkImageUploader = function( sInputID, fMultiple, fExternalSource ) {
    ...
    jQuery( '#select_image_' + sInputID ).click( function( e ) {
        ...
        oFeedZapper_AdminPageFrameworkOriginalImageUploaderSelectObject = wp.media.view.MediaFrame.Select;
        
        // Assign a custom select object
        wp.media.view.MediaFrame.Select = fExternalSource ? getFeedZapper_AdminPageFrameworkCustomMediaUploaderSelectObject() : oFeedZapper_AdminPageFrameworkOriginalImageUploaderSelectObject;
        ...
        _oCustomImageUploader.on( 'close', function() {
            ...
            if ( typeof( _oImage ) !== 'undefined'  ) {
                ...
                _oCustomImageUploader.state().get( 'selection' ).each( function( oAttachment, iIndex ) {
                    ...
                    var _oFieldContainer    = 'undefined' === typeof _oNewField 
                        ? jQuery( '#' + sInputID ).closest( '.feed-zapper-field' ) 
                        : _oNewField;
                    _oNewField              = jQuery( this ).addFeedZapper_AdminPageFrameworkRepeatableField( _oFieldContainer.attr( 'id' ) );
            ...
            wp.media.view.MediaFrame.Select = oFeedZapper_AdminPageFrameworkOriginalImageUploaderSelectObject;
...
removeInputValuesForImage = function( oElem ) {
    ...
    var _oImageInput = jQuery( oElem ).closest( '.feed-zapper-field' ).find( '.image-field input' );                  
    if ( _oImageInput.length <= 0 )  {
        return;
    }
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".feed-zapper-field .image_preview {border: none; clear: both; margin-top: 0.4em;margin-bottom: 0.8em;display: block; max-width: 100%;height: auto; width: inherit;} .feed-zapper-field .image_preview img { display: block;height: auto; max-width: 100%;}.widget .feed-zapper-field .image_preview {max-width: 100%;}@media only screen and ( max-width: 1200px ) {.feed-zapper-field .image_preview {max-width: 600px;} } @media only screen and ( max-width: 900px ) {.feed-zapper-field .image_preview {max-width: 440px;}}@media only screen and ( max-width: 600px ) {.feed-zapper-field .image_preview {max-width: 300px;}} @media only screen and ( max-width: 480px ) {.feed-zapper-field .image_preview {max-width: 240px;}}@media only screen and ( min-width: 1200px ) {.feed-zapper-field .image_preview {max-width: 600px;}}.feed-zapper-field-image input {margin-right: 0.5em;vertical-align: middle;}.select_image.button.button-small,.remove_image.button.button-small{ vertical-align: middle;}.remove_image.button.button-small {margin-left: 0.2em;}@media screen and (max-width: 782px) {.feed-zapper-field-image input {margin: 0.5em 0.5em 0.5em 0;}}";
    }
...
jQuery( document ).ready( function(){     
    setFeedZapper_AdminPageFrameworkImageUploader( '{$sInputID}', 'true' === '{$_sRepeatable}', 'true' === '{$_bExternalSource}' );
});
JAVASCRIPTS;
        return "<script type='text/javascript' class='feed-zapper-image-uploader-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='feed-zapper-{$sType}-remove-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
...
class FeedZapper_AdminPageFramework_FieldType_media extends FeedZapper_AdminPageFramework_FieldType_image {
...
jQuery( document ).ready( function(){
    ...
    jQuery().registerFeedZapper_AdminPageFrameworkCallbacks( {    
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            setFeedZapper_AdminPageFrameworkMediaUploader( 
    ...
    private function _getScript_MediaUploader($sReferrer) {
        ...
        if (!function_exists('wp_enqueue_media')) {
            return <<<JAVASCRIPTS
                     ...
                     * The fMultiple parameter does not do anything. It is there to be consistent with the one for the WordPress version 3.5 or above.
                     */
                    setFeedZapper_AdminPageFrameworkMediaUploader = function( sInputID, fMultiple, fExternalSource ) {
                        ...
                        jQuery( '#select_media_' + sInputID ).click( function() {
                            ...
                            window.original_send_to_editor = window.send_to_editor;
                            window.send_to_editor = hfFeedZapper_AdminPageFrameworkSendToEditorMedia;
                            var fExternalSource = jQuery( this ).attr( 'data-enable_external_source' );
                            tb_show( '{$_sThickBoxTitle}', 'media-upload.php?post_id=1&amp;enable_external_source=' + fExternalSource + '&amp;referrer={$sReferrer}&amp;button_label={$_sThickBoxButtonUseThis}&amp;type=image&amp;TB_iframe=true', false );
                            return false; // do not click the button after the script by returning false.     
                        });    
                    ...
                    var hfFeedZapper_AdminPageFrameworkSendToEditorMedia = function( sRawHTML, param ) {
        ...
        return <<<JAVASCRIPTS
                ...
                setFeedZapper_AdminPageFrameworkMediaUploader = function( sInputID, fMultiple, fExternalSource ) {
                    ...
                    jQuery( '#select_media_' + sInputID ).click( function( e ) {
                        ...
                        // Store the original select object in a global variable
                        oFeedZapper_AdminPageFrameworkOriginalMediaUploaderSelectObject = wp.media.view.MediaFrame.Select;
                        
                        // Assign a custom select object.
                        wp.media.view.MediaFrame.Select = fExternalSource ? getFeedZapper_AdminPageFrameworkCustomMediaUploaderSelectObject() : oFeedZapper_AdminPageFrameworkOriginalMediaUploaderSelectObject;
                        ...
                        _oMediaUploader.on( 'close', function() {
                            ...
                            // Restore the original select object.
                            wp.media.view.MediaFrame.Select = oFeedZapper_AdminPageFrameworkOriginalMediaUploaderSelectObject;    
                ...
                removeInputValuesForMedia = function( oElem ) {
                    ...
                    var _oImageInput = jQuery( oElem ).closest( '.feed-zapper-field' ).find( '.media-field input' );                  
                    if ( _oImageInput.length <= 0 )  {
                        return;
                    }
...
jQuery( document ).ready( function(){   
    setFeedZapper_AdminPageFrameworkMediaUploader( '{$sInputID}', 'true' === '{$_sRpeatable}', 'true' === '{$_sExternalSource}' );
});
JAVASCRIPTS;
        return "<script type='text/javascript' class='feed-zapper-media-uploader-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
