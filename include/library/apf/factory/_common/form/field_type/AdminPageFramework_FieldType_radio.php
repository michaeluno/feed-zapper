...
class FeedZapper_AdminPageFramework_FieldType_radio extends FeedZapper_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".feed-zapper-field input[type='radio'] {margin-right: 0.5em;} .feed-zapper-field-radio .feed-zapper-input-label-container {padding-right: 1em;} .feed-zapper-field-radio .feed-zapper-input-container {display: inline;} .feed-zapper-field-radio .feed-zapper-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.feed-zapper-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
