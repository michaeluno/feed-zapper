...
class FeedZapper_AdminPageFramework_FieldType_section_title extends FeedZapper_AdminPageFramework_FieldType_text {
    ...
    protected function getStyles() {
        return ".feed-zapper-section-tab .feed-zapper-field-section_title {padding: 0.5em;} .feed-zapper-section-tab .feed-zapper-field-section_title .feed-zapper-input-label-string { vertical-align: middle; margin-left: 0.2em;}.feed-zapper-section-tab .feed-zapper-fields {display: inline-block;} .feed-zapper-field.feed-zapper-field-section_title {float: none;} .feed-zapper-field.feed-zapper-field-section_title input {background-color: #fff;color: #333;border-color: #ddd;box-shadow: inset 0 1px 2px rgba(0,0,0,.07);border-width: 1px;border-style: solid;outline: 0;box-sizing: border-box;vertical-align: middle;}";
    }
