...
class FeedZapper_AdminPageFramework_FieldType_taxonomy extends FeedZapper_AdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new FeedZapper_AdminPageFramework_Form_View___Script_CheckboxSelector;
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        return parent::getScripts() . <<<JAVASCRIPTS
/* For tabs */
var enableFeedZapper_AdminPageFrameworkTabbedBox = function( nodeTabBoxContainer ) {
...
jQuery( document ).ready( function() {
    ...
    enableFeedZapper_AdminPageFrameworkTabbedBox( jQuery( '.tab-box-container' ) );
    ...
    jQuery().registerFeedZapper_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            // Initialize
            enableFeedZapper_AdminPageFrameworkTabbedBox( oCloned.find( '.tab-box-container' ) );
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".feed-zapper-field .taxonomy-checklist li { margin: 8px 0 8px 20px; }.feed-zapper-field div.taxonomy-checklist {padding: 8px 0 8px 10px;margin-bottom: 20px;}.feed-zapper-field .taxonomy-checklist ul {list-style-type: none;margin: 0;}.feed-zapper-field .taxonomy-checklist ul ul {margin-left: 1em;}.feed-zapper-field .taxonomy-checklist-label {white-space: nowrap; }.feed-zapper-field .tab-box-container.categorydiv {max-height: none;}.feed-zapper-field .tab-box-tab-text {display: inline-block;font-size: 13px;font-size: smaller;padding: 2px;}.feed-zapper-field .tab-box-tabs {line-height: 12px;margin-bottom: 0;}.feed-zapper-field .tab-box-tabs .tab-box-tab.active {display: inline;border-color: #dfdfdf #dfdfdf #fff;margin-bottom: 0px;padding-bottom: 4px;background-color: #fff;}.feed-zapper-field .tab-box-container { position: relative; width: 100%; clear: both;margin-bottom: 1em;}.feed-zapper-field .tab-box-tabs li a { color: #333; text-decoration: none; }.feed-zapper-field .tab-box-contents-container {padding: 0 0 0 1.8em;padding: 0.55em 0.5em 0.55em 1.8em;border: 1px solid #dfdfdf; background-color: #fff;}.feed-zapper-field .tab-box-contents { overflow: hidden; overflow-x: hidden; position: relative; top: -1px; height: 300px;}.feed-zapper-field .tab-box-content { display: none; overflow: auto; display: block; position: relative; overflow-x: hidden;}.feed-zapper-field .tab-box-content .taxonomychecklist {margin-right: 3.2em;}.feed-zapper-field .tab-box-content:target, .feed-zapper-field .tab-box-content:target, .feed-zapper-field .tab-box-content:target { display: block; }.feed-zapper-field .tab-box-content .select_all_button_container, .feed-zapper-field .tab-box-content .select_none_button_container{display: inline-block;margin-top: 0.8em;}.feed-zapper-field .taxonomychecklist .children {margin-top: 6px;margin-left: 1em;}";
    }
