...
abstract class FeedZapper_AdminPageFramework_Input_Base extends FeedZapper_AdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'feed-zapper-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'feed-zapper-input-label-string',),);
...
class FeedZapper_AdminPageFramework_Input_checkbox extends FeedZapper_AdminPageFramework_Input_Base {
