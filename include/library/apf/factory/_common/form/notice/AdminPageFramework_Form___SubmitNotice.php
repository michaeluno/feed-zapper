...
class FeedZapper_AdminPageFramework_Form___SubmitNotice extends FeedZapper_AdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        new FeedZapper_AdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices) {
        ...
        foreach (array_filter(( array )$aNotices, 'is_array') as $_aNotice) {
            ...
            new FeedZapper_AdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
}
