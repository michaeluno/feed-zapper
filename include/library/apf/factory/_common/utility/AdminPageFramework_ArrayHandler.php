...
class FeedZapper_AdminPageFramework_FrameworkUtility extends FeedZapper_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = FeedZapper_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return FeedZapper_AdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
}
class FeedZapper_AdminPageFramework_ArrayHandler extends FeedZapper_AdminPageFramework_FrameworkUtility {
    public $aData = array();
