...
class FeedZapper_AdminPageFramework_AdminNotice extends FeedZapper_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'feed-zapper-settings-notice-message', 'feed-zapper-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new FeedZapper_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
