...
class FeedZapper_AdminPageFramework_AdminNotice___Script extends FeedZapper_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.feed-zapper-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='feed-zapper-admin-notice-animation-container'></div>" );
