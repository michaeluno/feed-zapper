...
class FeedZapper_AdminPageFramework_Debug_Base extends FeedZapper_AdminPageFramework_FrameworkUtility {
...
class FeedZapper_AdminPageFramework_Debug_Log extends FeedZapper_AdminPageFramework_Debug_Base {
...
class FeedZapper_AdminPageFramework_Debug extends FeedZapper_AdminPageFramework_Debug_Log {
    ...
    static public function dumpArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('FeedZapper_AdminPageFramework_Debug::' . __FUNCTION__, 'FeedZapper_AdminPageFramework_Debug::dump()');
        FeedZapper_AdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
        self::showDeprecationNotice('FeedZapper_AdminPageFramework_Debug::' . __FUNCTION__, 'FeedZapper_AdminPageFramework_Debug::get()');
        return FeedZapper_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    static public function logArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('FeedZapper_AdminPageFramework_Debug::' . __FUNCTION__, 'FeedZapper_AdminPageFramework_Debug::log()');
        FeedZapper_AdminPageFramework_Debug::log($asArray, $sFilePath);
    }
    static public function getAsString($mValue) {
        self::showDeprecationNotice('FeedZapper_AdminPageFramework_Debug::' . __FUNCTION__);
