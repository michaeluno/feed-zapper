...
class FeedZapper_AdminPageFramework_WPUtility_URL extends FeedZapper_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(FeedZapper_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(FeedZapper_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = FeedZapper_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class FeedZapper_AdminPageFramework_WPUtility_HTML extends FeedZapper_AdminPageFramework_WPUtility_URL {
...
class FeedZapper_AdminPageFramework_WPUtility_Page extends FeedZapper_AdminPageFramework_WPUtility_HTML {
    ...
    static public function getCurrentScreenID() {
        ...
        if (isset($GLOBALS['page_hook'])) {
            return is_network_admin() ? $GLOBALS['page_hook'] . '-network' : $GLOBALS['page_hook'];
        }
        return '';
    }
...
class FeedZapper_AdminPageFramework_WPUtility_Hook extends FeedZapper_AdminPageFramework_WPUtility_Page {
...
class FeedZapper_AdminPageFramework_WPUtility_File extends FeedZapper_AdminPageFramework_WPUtility_Hook {
...
class FeedZapper_AdminPageFramework_WPUtility_Option extends FeedZapper_AdminPageFramework_WPUtility_File {
...
class FeedZapper_AdminPageFramework_WPUtility_Meta extends FeedZapper_AdminPageFramework_WPUtility_Option {
...
class FeedZapper_AdminPageFramework_WPUtility_SiteInformation extends FeedZapper_AdminPageFramework_WPUtility_Meta {
...
class FeedZapper_AdminPageFramework_WPUtility_SystemInformation extends FeedZapper_AdminPageFramework_WPUtility_SiteInformation {
...
class FeedZapper_AdminPageFramework_WPUtility extends FeedZapper_AdminPageFramework_WPUtility_SystemInformation {
