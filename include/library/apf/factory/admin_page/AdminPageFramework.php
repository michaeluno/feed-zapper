...
abstract class FeedZapper_AdminPageFramework_Router extends FeedZapper_AdminPageFramework_Factory {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'feed-zapper') {
        $_sProprtyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'FeedZapper_AdminPageFramework_Property_' . $this->_sStructureType;
    ...
    public function _replyToLoadComponentsForAjax() {
        ...
        new FeedZapper_AdminPageFramework_Model_Menu__RegisterMenu($this, 'pseudo_admin_menu');
...
abstract class FeedZapper_AdminPageFramework_Model_Form extends FeedZapper_AdminPageFramework_Router {
    public $aFieldErrors;
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'feed-zapper') {
        ...
        new FeedZapper_AdminPageFramework_Model__FormEmailHandler($this);
    ...
    public function _replyToHandleSubmittedFormData($aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        new FeedZapper_AdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
    }
...
abstract class FeedZapper_AdminPageFramework_View_Form extends FeedZapper_AdminPageFramework_Model_Form {
...
abstract class FeedZapper_AdminPageFramework_Controller_Form extends FeedZapper_AdminPageFramework_View_Form {
    ...
    public function getValue() {
        ...
        return FeedZapper_AdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
    }
...
abstract class FeedZapper_AdminPageFramework_Model_Page extends FeedZapper_AdminPageFramework_Controller_Form {
    public function _replyToFinalizeInPageTabs() {
        ...
        foreach ($this->oProp->aPages as $_sPageSlug => $_aPage) {
            ...
            $_oFormatter = new FeedZapper_AdminPageFramework_Format_InPageTabs($this->oProp->aInPageTabs[$_sPageSlug], $_sPageSlug, $this);
...
abstract class FeedZapper_AdminPageFramework_View_Page extends FeedZapper_AdminPageFramework_Model_Page {
    public function _replyToEnablePageMetaBoxes() {
        new FeedZapper_AdminPageFramework_View__PageMetaboxEnabler($this);
    }
    public function _replyToEnqueuePageAssets() {
        new FeedZapper_AdminPageFramework_View__Resource($this);
    }
    ...
    protected function _renderPage($sPageSlug, $sTabSlug = null) {
        $_oPageRenderer = new FeedZapper_AdminPageFramework_View__PageRenderer($this, $sPageSlug, $sTabSlug);
        $_oPageRenderer->render();
    }
}
abstract class FeedZapper_AdminPageFramework_Controller_Page extends FeedZapper_AdminPageFramework_View_Page {
...
abstract class FeedZapper_AdminPageFramework_Model_Menu extends FeedZapper_AdminPageFramework_Controller_Page {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'feed-zapper') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        new FeedZapper_AdminPageFramework_Model_Menu__RegisterMenu($this);
    }
}
abstract class FeedZapper_AdminPageFramework_View_Menu extends FeedZapper_AdminPageFramework_Model_Menu {
}
abstract class FeedZapper_AdminPageFramework_Controller_Menu extends FeedZapper_AdminPageFramework_View_Menu {
    ...
    public function addSubMenuLink(array $aSubMenuLink) {
        ...
        $_oFormatter = new FeedZapper_AdminPageFramework_Format_SubMenuLink($aSubMenuLink, $this, count($this->oProp->aPages) + 1);
    ...
    public function addSubMenuPage(array $aSubMenuPage) {
        ...
        $_oFormatter = new FeedZapper_AdminPageFramework_Format_SubMenuPage($aSubMenuPage, $this, count($this->oProp->aPages) + 1);
        $_aSubMenuPage = $_oFormatter->get();
        $this->oProp->aPages[$_aSubMenuPage['page_slug']] = $_aSubMenuPage;
    }
}
abstract class FeedZapper_AdminPageFramework_Model extends FeedZapper_AdminPageFramework_Controller_Menu {
}
abstract class FeedZapper_AdminPageFramework_View extends FeedZapper_AdminPageFramework_Model {
    public function content($sContent) {
        return $sContent;
    }
}
abstract class FeedZapper_AdminPageFramework_Controller extends FeedZapper_AdminPageFramework_View {
    ...
    public function setAdminNotice($sMessage, $sClassSelector = 'error', $sID = '') {
        ...
        new FeedZapper_AdminPageFramework_AdminNotice($this->oProp->aAdminNotices[$sID]['sMessage'], $this->oProp->aAdminNotices[$sID]['aAttributes'], array('should_show' => array($this, 'isInThePage'),));
    }
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return FeedZapper_AdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
    }
}
abstract class FeedZapper_AdminPageFramework extends FeedZapper_AdminPageFramework_Controller {
    protected $_sStructureType = 'admin_page';
    public function __construct($isOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'feed-zapper') {
    ...
    private function _getCallerPath($sCallerPath) {
        ...
        $_sCalllerPath = in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page']) ? FeedZapper_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null;
