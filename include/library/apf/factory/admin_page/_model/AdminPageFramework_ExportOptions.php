...
abstract class FeedZapper_AdminPageFramework_CustomSubmitFields extends FeedZapper_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class FeedZapper_AdminPageFramework_ExportOptions extends FeedZapper_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo FeedZapper_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
