...
class FeedZapper_AdminPageFramework_Property_admin_page extends FeedZapper_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'feed-zapper') {
        ...
        $GLOBALS['aFeedZapper_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aFeedZapper_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aFeedZapper_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
