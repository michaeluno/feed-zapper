...
class FeedZapper_AdminPageFramework_Model__FormEmailHandler extends FeedZapper_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    public function _replyToSendFormEmail() {
        ...
        $_oEmail = new FeedZapper_AdminPageFramework_FormEmail($_aFormEmail['email_options'], $_aFormEmail['input'], $_aFormEmail['section_id']);
        $_bSent = $_oEmail->send();
        exit;
    }
}
