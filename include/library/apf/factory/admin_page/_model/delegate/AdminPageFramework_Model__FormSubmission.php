...
abstract class FeedZapper_AdminPageFramework_Model__FormSubmission_Base extends FeedZapper_AdminPageFramework_Form_Utility {
...
class FeedZapper_AdminPageFramework_Model__FormSubmission extends FeedZapper_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new FeedZapper_AdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new FeedZapper_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
