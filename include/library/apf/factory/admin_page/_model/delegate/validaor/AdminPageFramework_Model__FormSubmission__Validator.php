...
class FeedZapper_AdminPageFramework_Model__FormSubmission__Validator_Base extends FeedZapper_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class FeedZapper_AdminPageFramework_Model__FormSubmission__Validator extends FeedZapper_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('FeedZapper_AdminPageFramework_Model__FormSubmission__Validator__Link', 'FeedZapper_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'FeedZapper_AdminPageFramework_Model__FormSubmission__Validator__Import', 'FeedZapper_AdminPageFramework_Model__FormSubmission__Validator__Export', 'FeedZapper_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'FeedZapper_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'FeedZapper_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'FeedZapper_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new FeedZapper_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
