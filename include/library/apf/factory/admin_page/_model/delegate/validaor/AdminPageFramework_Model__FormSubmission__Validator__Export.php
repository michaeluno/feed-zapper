...
class FeedZapper_AdminPageFramework_Model__FormSubmission__Validator__Import extends FeedZapper_AdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    private function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new FeedZapper_AdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
...
class FeedZapper_AdminPageFramework_Model__FormSubmission__Validator__Export extends FeedZapper_AdminPageFramework_Model__FormSubmission__Validator__Import {
    public $sActionHookPrefix = 'try_validation_after_';
    ...
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new FeedZapper_AdminPageFramework_ExportOptions($_POST['__export'], $this->oFactory->oProp->sClassName);
