...
class FeedZapper_AdminPageFramework_Format_SubMenuItem extends FeedZapper_AdminPageFramework_Format_Base {
    ...
    public function get() {
        ...
        if (isset($_aSubMenuItem['page_slug'])) {
            $_oFormatter = new FeedZapper_AdminPageFramework_Format_SubMenuPage($_aSubMenuItem, $this->oFactory, $this->iParsedIndex);
            return $_oFormatter->get();
        }
        if (isset($_aSubMenuItem['href'])) {
            $_oFormatter = new FeedZapper_AdminPageFramework_Format_SubMenuLink($_aSubMenuItem, $this->oFactory, $this->iParsedIndex);
            return $_oFormatter->get();
        }
        return array();
    }
