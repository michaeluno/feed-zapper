...
class FeedZapper_AdminPageFramework_View__PageRenderer extends FeedZapper_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTabSlug;
    ...
    public function render() {
        ...
        <div class="<?php echo esc_attr($this->oFactory->oProp->sWrapperClassAttribute); ?>">
            ...
            <div class="feed-zapper-container">    
                <?php
    ...
    private function _getContentTop() {
        $_oScreenIcon = new FeedZapper_AdminPageFramework_View__PageRenderer__ScreenIcon($this->oFactory, $this->sPageSlug, $this->sTabSlug);
        $_sContentTop = $_oScreenIcon->get();
        $_oPageHeadingTabs = new FeedZapper_AdminPageFramework_View__PageRenderer__PageHeadingTabs($this->oFactory, $this->sPageSlug);
        $_sContentTop.= $_oPageHeadingTabs->get();
        $_oInPageTabs = new FeedZapper_AdminPageFramework_View__PageRenderer__InPageTabs($this->oFactory, $this->sPageSlug);
    ...
    private function _printMainPageContent($sPageSlug, $sTabSlug) {
        ...
        echo "<div class='feed-zapper-content'>";
    ...
    private function _printPageMetaBoxes() {
        $_oPageMetaBoxRenderer = new FeedZapper_AdminPageFramework_View__PageMataBoxRenderer();
    ...
    private function _printFormOpeningTag($fEnableForm = true) {
        ...
        echo "<form " . $this->getAttributes(array('method' => 'post', 'enctype' => $this->oFactory->oProp->sFormEncType, 'id' => 'feed-zapper-form', 'action' => wp_unslash(remove_query_arg('settings-updated', $this->oFactory->oProp->sTargetFormPage)),)) . " >" . PHP_EOL;
