...
class FeedZapper_AdminPageFramework_View__Resource extends FeedZapper_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    private function _enqueueAsset_style($asPageStyle) {
        $_oFormatter = new FeedZapper_AdminPageFramework_Format_PageResource_Style($asPageStyle);
    ...
    private function _enqueueAsset_script($asPageScript) {
        $_oFormatter = new FeedZapper_AdminPageFramework_Format_PageResource_Script($asPageScript);
