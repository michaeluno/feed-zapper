...
abstract class FeedZapper_AdminPageFramework_MetaBox_Router extends FeedZapper_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'feed-zapper') {
...
abstract class FeedZapper_AdminPageFramework_MetaBox_Model extends FeedZapper_AdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'feed-zapper') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new FeedZapper_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class FeedZapper_AdminPageFramework_MetaBox_View extends FeedZapper_AdminPageFramework_MetaBox_Model {
...
abstract class FeedZapper_AdminPageFramework_MetaBox_Controller extends FeedZapper_AdminPageFramework_MetaBox_View {
...
abstract class FeedZapper_AdminPageFramework_MetaBox extends FeedZapper_AdminPageFramework_MetaBox_Controller {
