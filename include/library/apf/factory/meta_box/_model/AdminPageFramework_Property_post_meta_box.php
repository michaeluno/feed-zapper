...
class FeedZapper_AdminPageFramework_Property_post_meta_box extends FeedZapper_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'feed-zapper', $sStructureType = 'post_meta_box') {
