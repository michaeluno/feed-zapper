...
abstract class FeedZapper_AdminPageFramework_NetworkAdmin extends FeedZapper_AdminPageFramework {
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_network', $sTextDomain = 'feed-zapper') {
        if (!$this->_isInstantiatable()) {
            return;
        }
        $sCallerPath = $sCallerPath ? $sCallerPath : FeedZapper_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        new FeedZapper_AdminPageFramework_Model_Menu__RegisterMenu($this, 'network_admin_menu');
    }
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return FeedZapper_AdminPageFramework_WPUtility::getSiteOption($sOptionKey, $asKey, $vDefault);
    }
}
