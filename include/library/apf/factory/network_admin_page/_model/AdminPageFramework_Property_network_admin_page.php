...
class FeedZapper_AdminPageFramework_Property_network_admin_page extends FeedZapper_AdminPageFramework_Property_admin_page {
    ...
    protected function _getOptions() {
        return $this->addAndApplyFilter($this->getElement($GLOBALS, array('aFeedZapper_AdminPageFramework', 'aPageClasses', $this->sClassName)), 'options_' . $this->sClassName, $this->sOptionKey ? get_site_option($this->sOptionKey, array()) : array());
    }
