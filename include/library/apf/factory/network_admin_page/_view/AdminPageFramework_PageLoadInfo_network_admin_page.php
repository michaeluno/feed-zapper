...
class FeedZapper_AdminPageFramework_PageLoadInfo_network_admin_page extends FeedZapper_AdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new FeedZapper_AdminPageFramework_PageLoadInfo_network_admin_page($oProp, $oMsg);
        return self::$_oInstance;
    }
