...
abstract class FeedZapper_AdminPageFramework_PageMetaBox_Router extends FeedZapper_AdminPageFramework_MetaBox_View {
...
abstract class FeedZapper_AdminPageFramework_PageMetaBox_Model extends FeedZapper_AdminPageFramework_PageMetaBox_Router {
...
abstract class FeedZapper_AdminPageFramework_PageMetaBox_View extends FeedZapper_AdminPageFramework_PageMetaBox_Model {
}
abstract class FeedZapper_AdminPageFramework_PageMetaBox_Controller extends FeedZapper_AdminPageFramework_PageMetaBox_View {
...
abstract class FeedZapper_AdminPageFramework_PageMetaBox extends FeedZapper_AdminPageFramework_PageMetaBox_Controller {
    protected $_sStructureType = 'page_meta_box';
    public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'feed-zapper') {
