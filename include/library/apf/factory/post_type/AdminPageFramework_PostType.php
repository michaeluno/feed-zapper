...
abstract class FeedZapper_AdminPageFramework_PostType_Router extends FeedZapper_AdminPageFramework_Factory {
...
abstract class FeedZapper_AdminPageFramework_PostType_Model extends FeedZapper_AdminPageFramework_PostType_Router {
    public function __construct($oProp) {
        parent::__construct($oProp);
        ...
        if ($this->oProp->bIsAdmin) {
            ...
            if ($this->oProp->sCallerPath) {
                new FeedZapper_AdminPageFramework_PostType_Model__FlushRewriteRules($this);
            }
        }
    }
    ...
    public function _replyToRegisterPostType() {
        ...
        new FeedZapper_AdminPageFramework_PostType_Model__SubMenuOrder($this);
    }
...
abstract class FeedZapper_AdminPageFramework_PostType_View extends FeedZapper_AdminPageFramework_PostType_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        if ($this->oProp->bIsAdmin) {
    ...
    public function _replyToPrintStyle() {
        ...
        if (!empty($this->oProp->sStyle)) {
            echo "<style type='text/css' id='feed-zapper-style-post-type'>" . $this->oProp->sStyle . "</style>";
        }
    }
...
abstract class FeedZapper_AdminPageFramework_PostType_Controller extends FeedZapper_AdminPageFramework_PostType_View {
...
abstract class FeedZapper_AdminPageFramework_PostType extends FeedZapper_AdminPageFramework_PostType_Controller {
    protected $_sStructureType = 'post_type';
    public function __construct($sPostType, $aArguments = array(), $sCallerPath = null, $sTextDomain = 'feed-zapper') {
        if (empty($sPostType)) {
            return;
        }
        ...
        $this->oProp->sPostType = FeedZapper_AdminPageFramework_WPUtility::sanitizeSlug($sPostType);
        $this->oProp->aPostTypeArgs = $aArguments;
    ...
    private function _getCallerScriptPath($sCallerPath) {
        ...
        $_sPageNow = FeedZapper_AdminPageFramework_Utility::getElement($GLOBALS, 'pagenow');
        if (in_array($_sPageNow, array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php', 'term.php'))) {
            return FeedZapper_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
        }
        return null;
    }
}
