...
abstract class FeedZapper_AdminPageFramework_TaxonomyField_Router extends FeedZapper_AdminPageFramework_Factory {
...
abstract class FeedZapper_AdminPageFramework_TaxonomyField_Model extends FeedZapper_AdminPageFramework_TaxonomyField_Router {
...
abstract class FeedZapper_AdminPageFramework_TaxonomyField_View extends FeedZapper_AdminPageFramework_TaxonomyField_Model {
...
abstract class FeedZapper_AdminPageFramework_TaxonomyField_Controller extends FeedZapper_AdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class FeedZapper_AdminPageFramework_TaxonomyField extends FeedZapper_AdminPageFramework_TaxonomyField_Controller {
    protected $_sStructureType = 'taxonomy_field';
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'feed-zapper') {
