...
class FeedZapper_AdminPageFramework_Form_taxonomy_field extends FeedZapper_AdminPageFramework_Form {
    ...
    public function get() {
        ...
        $_oFieldsets = new FeedZapper_AdminPageFramework_Form_View___FieldsetRows($this->getElementAsArray($this->aFieldsets, '_default'), null, $this->aSavedData, $this->getFieldErrors(), $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
