...
abstract class FeedZapper_AdminPageFramework_TermMeta_Router extends FeedZapper_AdminPageFramework_TaxonomyField_Controller {
}
abstract class FeedZapper_AdminPageFramework_TermMeta_Model extends FeedZapper_AdminPageFramework_TermMeta_Router {
    ...
    private function _getSavedTermMetas($iTermID, array $aFieldsets) {
        $_oMetaData = new FeedZapper_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
...
abstract class FeedZapper_AdminPageFramework_TermMeta_View extends FeedZapper_AdminPageFramework_TermMeta_Model {
...
abstract class FeedZapper_AdminPageFramework_TermMeta_Controller extends FeedZapper_AdminPageFramework_TermMeta_View {
}
abstract class FeedZapper_AdminPageFramework_TermMeta extends FeedZapper_AdminPageFramework_TermMeta_Controller {
    protected $_sStructureType = 'term_meta';
    public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'feed-zapper') {
