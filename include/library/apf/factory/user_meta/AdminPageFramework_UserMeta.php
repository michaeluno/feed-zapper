...
abstract class FeedZapper_AdminPageFramework_UserMeta_Router extends FeedZapper_AdminPageFramework_Factory {
...
abstract class FeedZapper_AdminPageFramework_UserMeta_Model extends FeedZapper_AdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData() {
        $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
        $_oMetaData = new FeedZapper_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
...
abstract class FeedZapper_AdminPageFramework_UserMeta_View extends FeedZapper_AdminPageFramework_UserMeta_Model {
...
abstract class FeedZapper_AdminPageFramework_UserMeta_Controller extends FeedZapper_AdminPageFramework_UserMeta_View {
...
abstract class FeedZapper_AdminPageFramework_UserMeta extends FeedZapper_AdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability = 'read', $sTextDomain = 'feed-zapper') {
