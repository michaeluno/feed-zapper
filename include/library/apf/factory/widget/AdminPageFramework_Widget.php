...
abstract class FeedZapper_AdminPageFramework_Widget_Router extends FeedZapper_AdminPageFramework_Factory {
...
abstract class FeedZapper_AdminPageFramework_Widget_Model extends FeedZapper_AdminPageFramework_Widget_Router {
    ...
    public function _replyToRegisterWidget() {
        ...
        $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName] = new FeedZapper_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
        $this->oProp->oWidget = $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName];
    }
}
abstract class FeedZapper_AdminPageFramework_Widget_View extends FeedZapper_AdminPageFramework_Widget_Model {
...
abstract class FeedZapper_AdminPageFramework_Widget_Controller extends FeedZapper_AdminPageFramework_Widget_View {
...
abstract class FeedZapper_AdminPageFramework_Widget extends FeedZapper_AdminPageFramework_Widget_Controller {
    protected $_sStructureType = 'widget';
    public function __construct() {
        $_sThisClassName = get_class($this);
        $_bAssumedAsWPWidget = 0 === func_num_args();
        $_aDefaults = array('', array(), 'edit_theme_options', 'feed-zapper');
    ...
    private function ___setProperties($aParameters, $sThisClassName, $_bAssumedAsWPWidget) {
        ...
        $_sPropertyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'FeedZapper_AdminPageFramework_Property_' . $this->_sStructureType;
