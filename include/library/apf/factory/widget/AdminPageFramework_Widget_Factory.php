...
class FeedZapper_AdminPageFramework_Widget_Factory extends WP_Widget {
    public $oCaller;
    ...
    public function form($aSavedFormData) {
        ...
        $this->oCaller->oForm = new FeedZapper_AdminPageFramework_Form_widget(array('register_if_action_already_done' => false,) + $this->oCaller->oProp->aFormArguments, $this->oCaller->oForm->aCallbacks, $this->oCaller->oMsg);
