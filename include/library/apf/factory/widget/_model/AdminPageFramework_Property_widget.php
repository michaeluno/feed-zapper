...
class FeedZapper_AdminPageFramework_Property_widget extends FeedZapper_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'feed-zapper', $sStructureType) {
