...
class FeedZapper_AdminPageFramework_Form_widget extends FeedZapper_AdminPageFramework_Form {
    public $sStructureType = 'widget';
    public function construct() {
        $this->_addDefaultResources();
    }
    private function _addDefaultResources() {
        $_oCSS = new FeedZapper_AdminPageFramework_Form_View___CSS_widget;
