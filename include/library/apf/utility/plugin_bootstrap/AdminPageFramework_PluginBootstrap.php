...
abstract class FeedZapper_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('FeedZapper_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new FeedZapper_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
